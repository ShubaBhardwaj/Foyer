...
import { ArrowLeft, Bell, History } from "lucide-react-native";
...
export const FacilitiesHeader = React.memo(function FacilitiesHeader({
  title,
  showBack = false,
  onBackPress,
  rightActionIcon: RightIcon = Bell,
  onRightActionPress,
}: FacilitiesHeaderProps) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.rightSlot}>
        <AppIconButton
          ...
          accessibilityLabel="Header right action"
        />
      </View>
    </View>
  );
