...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-[var(--surface-variant)]/40 p-1 text-[var(--on-surface)]/70 border border-[var(--outline)]/30",
      className
    )}
    {...props}
  />
